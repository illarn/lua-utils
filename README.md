...
- [`illarn.class_name`](illarn/class_name.lua) - get string class name from a lua object
- [`illarn.deep_copy`](illarn/deep_copy.lua)- create a deep copy of a lua table
- [`illarn.logger`](illarn/logger.lua) - simple logger with terminal colors
- [`illarn.pool`](illarn/pool.lua) - object pooling
